...
function InputField({ placeHolder }) {
    return (
        <div className="relative w-full">
            ...
            <input
                type="text"
                className="h-16 py-3 px-28 block w-full focus:outline-none border-2 placeholder-grey border-white rounded-full text-lg focus:border-grey  bg-light-grey"
                placeholder={placeHolder} />
            <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                <button className='w-10 h-10 bg-purple rounded-full'>
